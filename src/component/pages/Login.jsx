...
function Login() {
  ...
  const [msg, setMsg] =useState('no password')

  const loginUandPass = async(e) => {
    e.preventDefault()
      ...
      <div className="container flex justify-center mt-10 "> 
        <div className="card w-96 bg-base-100 shadow-xl">
              ...
              <div className="card-actions justify-center">
                  <button className="btn btn-wide btn-outline btn-primary btn-[#AA4A4A]" onClick={(e) => loginUandPass(e)}>Log In</button> 
              </div>
